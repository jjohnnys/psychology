...
insert into patient (id, name, cpf, rg, date_birth, price, schooling, gender, address, status, observation) values ('paciente_5', 'June', '444.441.558-88', '55.75.854-4', '1991-09-15', 100, 'Dontorado', 'Feminino', 'Grecia', 'Tratamento Finalizado', 'Persistente');
