...
public class PsychologicalSupportTest {
    ...
    public void jdbcPatientTest() {
        ...
        Contact contactIkki = Contact.buildPatientContact(UUID.randomUUID().toString(), "ikki@mail.com", "85 98745", patients.get(0).getId());
        ...
        Contact contactEsmeralda = Contact.buildPatientContact(UUID.randomUUID().toString(), "esmeralda@mail.com", "85 98744", minorInserted.getId());
        contactRepository.insertContact(contactEsmeralda);
        Contact contactParanteOfEsmeralda = Contact.buildPatientContact(UUID.randomUUID().toString(), "ikki@mail.com", "85 98745", minorInserted.getId());
